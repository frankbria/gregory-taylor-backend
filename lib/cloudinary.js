 ...
 * @throws {Error} If publicId is null, undefined, or empty string
 */
export function getDisplayUrl(publicId, options = {}) {
  // Validate publicId
  if (!publicId || typeof publicId !== 'string' || publicId.trim() === '') {
    throw new Error('getDisplayUrl: publicId must be a non-empty string')
  }
...
export function getSignedDisplayUrl(publicId, options = {}) {
  // Validate publicId
  if (!publicId || typeof publicId !== 'string' || publicId.trim() === '') {
    throw new Error('getSignedDisplayUrl: publicId must be a non-empty string')
  }
